...
//  cout<<"start select_field_data_source::select_field_data_source\n";
  ...
  edit_layout_only_button_p = new button("Edit layout only");
  message_p = new QLabel("Or select type of data for a new field.");
  ...
  layout_p->addWidget(edit_layout_only_button_p, 0, 0);
  ...
  connect(edit_layout_only_button_p, SIGNAL(clicked()), this, SLOT(edit_layout_only_clicked()));
...
void select_field_data_source::edit_layout_only_clicked()
{
